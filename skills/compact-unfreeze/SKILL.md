...
Claude Code's official `/compact` has a bug: running it from the remote client freezes the next remote input until the loop is woken. This skill works around it.
